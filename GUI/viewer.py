...
class OpenGLViewer(QOpenGLWidget):
    def __init__(self, parent=None):
        ...
        self.component_terminals = {
            ...
            "microcontroller.obj": [(-0.375, -0.225),(-0.375,  0.225),(-0.225, -0.25),(-0.225,  0.25),(-0.125, -0.25),(-0.125,  0.25),(-0.025, -0.25),(-0.025,  0.25),( 0.075, -0.25),( 0.075,  0.25),( 0.175, -0.25),( 0.175,  0.25),( 0.27,  -0.24),( 0.27,   0.24)], #top to bottom - (right, left)
